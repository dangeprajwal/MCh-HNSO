...
A **blackish, non-ulcerated, rapidly expanding 3 cm lesion** on the central upper alveolus in a 45-year-old male strongly suggests **mucosal melanoma** of the oral cavity. The differential diagnosis includes:

| Diagnosis | Key Features | How to Differentiate |
|---|---|---|
| Mucosal melanoma | Pigmented, rapidly expanding | S-100+, HMB-45+, Melan-A+ |
| Melanotic macule | Flat, stable, no growth | Benign melanocytes, no atypia |
| Amalgam tattoo | Localized blue-grey | History of dental work, metallic particles |
...
- **Head and neck mucosal melanoma** is the second most common site after anorectal (40–55% of all mucosal melanomas)
- Oral cavity: **hard palate** (40%) and **upper gingiva/alveolus** (30%) are the most common sites
- Men affected **3× more** commonly than women
...
- **Proliferation of atypical melanocytes** in the basal layer and submucosa
- Pagetoid spread through epithelium
- May be **amelanotic** in 10–30% of cases — diagnostic challenge
- High mitotic rate, nuclear pleomorphism

### Immunohistochemistry

| Marker | Sensitivity | Notes |
|---|---|---|
| S-100 protein | 95–100% | Most sensitive but least specific |
| HMB-45 | 80–90% | Highly specific for melanoma |
| Melan-A/MART-1 | 80–90% | Excellent specificity |
| SOX10 | 95–98% | Nuclear stain, emerging gold standard |
| Ki-67 | Variable | Prognostic — high index = aggressive |

### Molecular Profile

Mucosal melanomas have a **distinct molecular profile** from cutaneous melanoma:

| Feature | Cutaneous Melanoma | Mucosal Melanoma |
|---|---|---|
| BRAF V600E mutation | 40–60% | 3–10% |
| c-KIT mutation/amp | 2–5% | 15–40% |
| NRAS mutation | 15–20% | 5–15% |
| Copy number changes | Fewer | Extensive |
| PD-L1 expression | 30–40% | 20–30% |
...
Surgery is the **primary treatment** when feasible. However, complete excision with wide margins is often challenging due to the anatomical constraints of the oral cavity.
...
|---|---|---|
| Nivolumab/Pembrolizumab | Anti-PD-1 | Unresectable/metastatic; lower response vs cutaneous (ORR ~20%) |
| Ipilimumab + Nivolumab | Anti-CTLA-4 + anti-PD-1 | Combination improves response |
| Imatinib | c-KIT inhibitor | c-KIT mutant mucosal melanoma (ORR 16–23%) |
| Temozolomide/Dacarbazine | Alkylating agent | Palliative chemotherapy |
...
| Local recurrence rate | 40–80% |
| Distant metastasis rate | 50–60% |
| Nodal metastasis at presentation | 25–40% |

**Poor prognostic factors:** tumour thickness >5 mm, ulceration, positive margins, nodal metastasis, amelanotic histology, vascular invasion.
...
1. **Biopsy** → confirm melanoma with IHC + molecular profiling
2. **Staging** → MRI face, PET-CT whole body
3. **Surgery** → partial/infrastructure maxillectomy with wide margins + ipsilateral selective neck dissection
4. **Reconstruction** → obturator prosthesis or free flap
5. **Adjuvant RT** → 50–60 Gy to primary site and neck
...
> 7. Adjuvant RT improves locoregional control and is recommended for most resected cases
