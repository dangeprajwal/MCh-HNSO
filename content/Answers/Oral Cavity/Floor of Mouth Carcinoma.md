...
| Structure | Relationship | Surgical Significance |
|---|---|---|
| Mylohyoid muscle | Forms floor partition | Tumour breach → neck extension |
| Sublingual gland | Lies within FOM | Early invasion pathway |
| Wharton's duct | Opens at caruncle | Must be preserved or transplanted |
| Lingual nerve | Crosses deep to duct | Sacrifice may be needed for deep tumours |
| Lingual artery | Deep to hyoglossus | Control needed for advanced resections |
| Mandible | Lateral boundary | Proximity determines mandibulectomy need |
...
### Site Distribution (Western vs Indian)

| Region | Tongue (%) | FOM (%) | Buccal (%) |
|---|---|---|---|
| United Kingdom | 36 | 35 | 10 |
| United States | 36 | 68 | 7 |
| India | 22 | 4 | 43 |
...
| Direction | Structures Involved | Clinical Implication |
|---|---|---|
| Lateral | Mandibular periosteum → cortex | Marginal vs segmental mandibulectomy |
| Deep | Sublingual gland → genioglossus | Partial glossectomy may be needed |
| Posterior | Tongue base, anterior pillar | Staging upshift, worse prognosis |
| Inferior | Through mylohyoid → submental space | Neck extension, bimanual palpation essential |
...
- Painful ulcer or indurated mass on the FOM
- Difficulty with tongue movement and speech
- Drooling due to Wharton's duct obstruction
- Submandibular swelling mimicking sialoadenitis
- [[Answers/Oral Cavity/Imaging in Oral Cancer|Advanced cases]]: fixation to mandible, skin infiltration

### Essential Examination

- **Bimanual palpation** — mandatory for assessing deep extent and mylohyoid breach
- **Tongue mobility** — restriction suggests deep muscle invasion
...
### Nodal Metastasis Rates

FOM is a **high-risk subsite** for cervical nodal metastases:

| T Stage | Occult Metastasis Rate | Primary Echelon |
|---|---|---|
| T1 | 12–20% | Level I (submental, submandibular) |
| T2 | 20–30% | Level I–II |
| T3–T4 | 47–53% | Levels I–III bilateral |

McGuirt et al. documented a **23% rate of occult disease** in 129 patients with FOM cancer.
...
**Early Disease (T1–T2):**
- **Transoral excision** — anterior and lateral FOM lesions can be resected per-orally with mucosal advancement or skin graft
- Wharton's ducts must be carefully dissected and transplanted laterally during anterior FOM excision
- Superficial lesions excised with little morbidity
- 10% local failure rate for T1–T2 treated surgically

**Advanced Disease (T3–T4):**
- Combination of surgery and radiation therapy
- Resection may require:
  - Partial glossectomy
  - [[Answers/Oral Cavity/Marginal Mandibulectomy|Marginal mandibulectomy]] (periosteal abutment only)
  - [[Answers/Oral Cavity/Types of Mandibulectomy|Segmental mandibulectomy]] (cortical invasion)
  - Bilateral neck dissection for midline tumours
- Reconstruction with skin grafts, pedicled flaps, or free tissue transfer

### Mandible Management Algorithm

| Clinical Finding | Imaging | Mandible Procedure |
|---|---|---|
| Tumour away from mandible | No bone involvement | No mandibulectomy |
| Tumour abutting periosteum | No cortical erosion on CT | Marginal mandibulectomy |
| Cortical erosion | CT confirms erosion | Segmental mandibulectomy |
| Medullary invasion | MRI marrow signal change | Segmental with reconstruction |

### Reconstruction Options

| Defect Size | Reconstruction | Notes |
|---|---|---|
| Small mucosal defect | Primary closure, skin graft | Bolster skin graft technique |
| Moderate soft tissue | Radial forearm free flap | Thin, pliable tissue ideal for FOM |
...
| Stage | 5-Year Overall Survival | Local Control |
|---|---|---|
| I | 75–85% | 90% (surgery) |
| II | 65–75% | 84% (surgery) |
| III | 45–55% | 79% (surgery + RT) |
| IV | 20–30% | Variable |

- Early lesions (T1–T2): **10% local failure** with surgery; neck failure (40%) is a bigger concern in T3–T4
...
> 2. **Sublingual gland invasion** is an early deep spread pathway — resect en bloc with FOM tumour when deep extension is present
