...
> - Describe the various aetiologies and risk factors for head and neck cancers stressing the role of oncogenic viruses (AMRITA 2018)
> - Discuss the role of Viruses in carcinogenesis (TMH 2018)

**Source:** Harrison - Head and Neck Cancer: A Multidisciplinary Approach, Chapter 12 (HPV and Oropharyngeal Cancer); Scott-Brown's Otorhinolaryngology Volume 3, Chapter 6 (Molecular Biology of HNC)
...
## Part A: Human Papillomavirus (HPV)
...
### The Critical Step: Viral Integration

As described in Harrison's Head and Neck Cancer (Chapter 12), incorporation of the viral genome into the host genome — rather than remaining in the episomal (circular) form — may be a critical step in carcinogenesis. In the normal viral life cycle, HPV maintains its genome as an episome in the basal keratinocytes, relying on host cellular machinery to replicate along with the host DNA. As host cells differentiate and move to the superficial layers, viral DNA is packaged within capsids and released as the epithelium desquamates. In this productive infection, the immune system eventually clears the virus.

In carcinogenesis, viral DNA insertion into the host genome tends to occur at certain fragile sites. This integration event interrupts the **E2 gene** — which normally acts as a transcriptional repressor of E6 and E7. Loss of E2 leads to constitutive, unregulated overexpression of E6 and E7 oncoproteins, locking the cell into a state of continuous proliferation with disabled p53 and Rb tumour suppressors. This is the point of no return in HPV-mediated carcinogenesis.

### Epidemiological Trends

The SEER data analyzed by Chaturvedi et al. revealed that the incidence of all oropharyngeal carcinomas increased significantly between 1973 and 2004, with an annual percentage increase of 0.8%. The incidence of HPV-positive oropharyngeal cancer increased dramatically during this period, while HPV-negative oropharyngeal cancers declined by approximately half — a trend mirroring the decline in tobacco-related HNSCCs at other sites. Across oropharyngeal subsites, the incidence of base of tongue and tonsillar carcinomas increased most significantly (annual incremental rates of 1.3% and 0.6%, respectively). The proportion of all HNSCC originating from the oropharynx increased from 18% in 1973 to 31% in 2004. It was estimated that the number of HPV-positive oropharyngeal cancers would surpass the number of cervical cancers by 2020 — a prediction that has been confirmed.

### Why HPV+ Tumours Have Better Prognosis

Several mechanisms explain the superior treatment outcomes in HPV-positive OPSCC, which was conclusively demonstrated in the landmark RTOG 0129 trial (Ang et al., 2010) showing a 58% reduction in death risk compared to HPV-negative disease.

First, because p53 is **wild-type** (merely degraded by E6, not mutated), it retains the ability to be reactivated when E6 expression is disrupted — for example, by radiation-induced DNA damage that overwhelms the E6-mediated degradation pathway. This means HPV+ tumour cells retain the capacity for p53-dependent apoptosis following chemoradiation, unlike HPV-negative tumours where p53 is permanently inactivated by missense mutation.

Second, HPV+ tumours have fewer total genetic mutations compared to HPV-negative disease. The TCGA analysis demonstrated that HPV-negative HNSCC harbours a median of approximately 130 mutations per tumour, whereas HPV-positive tumours have significantly fewer — resulting in less genomic chaos and more predictable treatment response.

Third, the expression of foreign viral antigens (E6, E7) on tumour cell surfaces makes them recognizable by the adaptive immune system, generating anti-tumour cytotoxic T-cell responses that augment the efficacy of chemoradiation. This immunogenicity also makes HPV-positive cancers attractive targets for immunotherapy.

Fourth, HPV+ patients are typically younger (40s-50s vs. 60s-70s), have fewer tobacco and alcohol-related comorbidities, and have better baseline performance status — contributing to better treatment tolerance, fewer treatment breaks, and fewer competing causes of death.

These observations have led to de-escalation clinical trials in HPV-positive OPSCC, which aim to reduce treatment intensity (and therefore long-term toxicity) while maintaining excellent cure rates. However, it is critical to note that de-escalation should only be performed within the context of clinical trials — standard-of-care treatment for HPV-positive OPSCC remains concurrent chemoradiation at full dose until trial results establish the safety of reduced treatment.

### HPV+ vs HPV− HNSCC

| Feature | HPV-Positive | HPV-Negative |
|---------|-------------|--------------|
| Site | Oropharynx (tonsil, BOT) | Oral cavity, larynx, hypopharynx |
| Risk factors | Sexual behaviour, young age | Tobacco, alcohol |
| p53 | Wild-type (degraded by E6) | Mutated (60-80%) |
| p16 | Overexpressed (surrogate marker) | Lost/inactivated |
| Total mutations | Fewer | More |
| Prognosis | Significantly better | Worse |
| 3-year OS (RTOG 0129) | 82.4% | 57.1% |
| Response to CRT | Excellent | Less responsive |
| Staging | Separate AJCC 8th edition staging | Standard staging |

### Detection of HPV

| Method | Target | Clinical Use |
|--------|--------|-------------|
...
Almost all NPC cells contain EBV DNA. Critically, antibody titres to EBV antigens correlate with stage of disease — a fall reflects tumour response to treatment, whereas a rise in antibody levels indicates disease progression. This observation forms the basis for using EBV serology and circulating EBV DNA for disease monitoring.

NPC screening efforts in endemic areas (such as southern China) use a two-stage approach: subjects are first identified if their blood shows evidence of active EBV infection (elevated VCA-IgA, EA-IgA), and these high-risk individuals are then given regular nasopharyngeal examinations. This strategy is being evaluated for its ability to detect NPC at earlier, more treatable stages.
...
## Part C: HIV and Head and Neck Cancer

- HIV-infected patients have an **increased relative risk of 2-3** for developing HNSCC
- Immunosuppression may impair surveillance of HPV and EBV
- HIV+ patients with HNSCC tend to present at younger age
- Treatment outcomes are comparable with appropriate antiretroviral therapy
- Higher rates of treatment toxicity due to immunocompromised state

---

## Part D: Other Viruses

- **HHV-8 (Human Herpesvirus 8):** Associated with Kaposi sarcoma of the oral cavity and oropharynx in HIV/AIDS patients
- **HTLV-1:** Associated with adult T-cell lymphoma, which can present in the head and neck

---

> [!abstract] Key Points
> 1. HPV16 is the established cause of a distinct subset of oropharyngeal SCC — 60-80% prevalence in Western countries
> 2. HPV E6 degrades p53 (via ubiquitin pathway); E7 inactivates Rb → together they bypass both major cell cycle checkpoints
> 3. p16 overexpression is a surrogate marker of HPV — results from loss of Rb negative feedback on p16
> 4. HPV+ OPC has dramatically better prognosis: 82% vs 57% 3-year OS (Ang et al. RTOG 0129)
> 5. HPV+ and HPV− HNSCC are now recognized as different diseases with separate AJCC 8th edition staging
> 6. EBV causes nasopharyngeal carcinoma through LMP1 (NF-κB activation), LMP2, and EBNA1
> 7. EBER ISH is the gold standard for EBV detection in tissue; plasma EBV DNA for screening and monitoring
> 8. HIV increases HNSCC risk 2-3 fold — likely through impaired immune surveillance of HPV and EBV
> 9. zur Hausen's Nobel Prize-winning work established papillomavirus-cancer link and the basis for HPV vaccination
> 10. Gillison et al. (2000) provided the first molecular proof that HPV causes a subset of HNSCC — a paradigm-changing study

> [!tip] Clinical Pearls
> - Always test for p16/HPV in oropharyngeal SCC — it determines staging (AJCC 8th ed.) and prognosis
> - p16 IHC is sufficient for clinical decision-making in oropharyngeal cancer; E6/E7 mRNA is the gold standard but rarely needed
> - HPV+ OPC patients are typically younger, non-smokers, with cystic neck nodes and small primaries — don't dismiss as benign
> - Plasma EBV DNA is increasingly used for NPC screening in endemic populations and for real-time treatment monitoring
> - De-escalation trials for HPV+ OPC are ongoing — do NOT de-escalate treatment outside of clinical trials
> - HPV vaccination (Gardasil 9) targets HPV16/18 and may reduce future HPV-related HNSCC incidence — recommend for eligible patients
